<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="NuevoTramiteNC.aspx.cs" Inherits="WFO.Procesos.Promotoria.NuevoTramiteNC" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><small>Individual Privado Emisión - Gastos Médicos - NC</small></h2>
                        ...
                        <div class="x_content text-left">
                            ...
                            <div class="row">
                                <asp:Label ID="Label3" runat="server" Text="* Tipo de trámite" Font-Bold="true" class="control-label col-md-1 col-sm-1 col-xs-6 "></asp:Label>
                                <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                                    <asp:DropDownList ID="DropDownListTipoTramite" runat="server" AutoPostBack="True" class="form-control">
                                        <asp:ListItem Value=" ">Seleccionar</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="DropDownListTipoTramite" ErrorMessage="*" InitialValue="-1" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="x_content text-left">
                        ...
                        <div class="row">
                            <div class="col-md-1 col-sm-1 col-xs-12 text-center">
                                <asp:Button ID="BtnContinuar" runat="server"  AutoPostBack="True" Text="Continuar" Class="btn btn-success" OnClick="BtnContinuar_Click" OnClientClick="return preventMultipleSubmissions('#ContenidoPrincipal_BtnContinuar');"/>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-12 text-center">
