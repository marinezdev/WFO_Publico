<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="NuevoTramite3.aspx.cs" Inherits="WFO.Procesos.Promotoria.NuevoTramire3" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><small>Individual Público Emisión - Gastos Médicos - Fase 3</small></h2>
                        ...
                        <div class="x_content text-left">
                                ...
                                <div class="row">
                                    <asp:Panel ID="producto1" runat="server" Visible="true">
                                        <asp:Label ID="lblProducto" runat="server" Text="*Producto" Font-Bold="true" class="control-label col-md-2 col-sm-2 col-xs-6 "></asp:Label>
                                ...
                                <div class="row">
                                    ...
                                    <asp:Label runat="server" ID="Moneda" Text="*Moneda" Font-Bold="True" class="control-label col-md-2 col-sm-2 col-xs-6" Visible="false"></asp:Label>
                                    <asp:DropDownList ID="cboMoneda" runat="server" AutoPostBack="True" TabIndex="1"  class="form-control" Visible="false"></asp:DropDownList>
                                    ...
                                    <asp:Label ID="Label1" runat="server" Text="*Riesgos" Font-Bold="true" class="control-label col-md-2 col-sm-2 col-xs-6 "></asp:Label>
                                        <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                                        <asp:DropDownList ID="LisRiesgos" runat="server" AutoPostBack="True" class="form-control">
                                            <asp:ListItem Value="-1">Seleccionar</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="LisRiesgos" ErrorMessage="*" InitialValue="-1" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>

                                    <asp:Label runat="server" ID="SumaAsegurada" Text="* Prima Total de Acuerdo a Cotización" Font-Bold="True" class="control-label col-md-3 col-sm-3 col-xs-6"></asp:Label>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="right col-xs-12 text-left">
                                                    ...
                                                    <asp:CheckBoxList ID="DocRequerid" runat="server" CssClass="cbl">
                                                        <asp:ListItem Selected="False" Text="Solicitud" Value="2" />
                                                        <asp:ListItem Selected="False" Text="Documentos del artículo 492 (copia de identificación debidamente, comprobante de domicilio debidamente cotejado)" Value="1" />
                                                        <asp:ListItem Selected="False" Text="Cotización" Value="3" />
                                                        <asp:ListItem Selected="False" Text="Token" Value="4" />
                                                    </asp:CheckBoxList>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content text-left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                                <code><asp:Label ID="SumaBasica" runat="server" ></asp:Label><asp:Label ID="Mensajes" runat="server"></asp:Label></code>
                            </div>
                        </div>
                    </div>
                </div>
