...
{
    public partial class NuevoTramire3 : Utilerias.Comun
    {
        ...
        protected void CrearTramite()
        {
            if (ValidaExpediente())
            {
                ...
                List<prop.RespuestaNuevoTramiteN1> respuestaNuevoTramiteN1s = tramiteN1.NuevoTramiteN1(NuevoTramite,0,"");

                if (respuestaNuevoTramiteN1s[0].Folio == "KO")
                {
                    SumaBasica.Text = "No registrado";
                }
                else
                {
        ...
        private void ListaRiesgos()
        {
            List<prop.cat_riesgos> cat_Riesgos = Catalogos.Cat_Riesgos();
