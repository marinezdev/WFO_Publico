...
namespace WFO.Procesos.SupervisionGeneral
{
    public partial class ConsultaTramite : Utilerias.Comun
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                string script = "";
                script = "window.location.href='../Supervision/MapaGeneral.aspx'; ";
        ...
        private void MuestraTramitePorEstatus(string Estatus, int IdTramite)
        {
            ...
            switch (Estatus)
            {
                ...
                case "Cancelado":
                    ...
                    ltMuestraCarta.Text = "<iframe src='..\\Promotoria\\Cartas\\CartaPDFCancelar.aspx" + Encrypt + "' style='width:100%; height:450px' style='border: none;'></iframe>";
        ...
        protected void BtnExpedienteAbrir_click(object sender, EventArgs e)
        {
            ...
            int TipoTramite = int.Parse(hfIdTipoTramite.Value);


            string script = "window.open('" + EncripParametros("IdTramite=" + Id + ",IdTipoTramite=" + TipoTramite, "../Operador/Displaypdf.aspx").URL + "','Expediente', 'width = 600, height = 400');";
            ScriptManager.RegisterStartupScript(this, GetType(), "ServerControlScript", script, true);
        ...
        {
            int TipoTramite = int.Parse(hfIdTipoTramite.Value.ToString());
            ltMuestraPdf.Text = "";
            ltMuestraPdf.Text = "<iframe src='" + EncripParametros("IdTramite=" + Id + ",IdTipoTramite=" + TipoTramite, "../Operador/Displaypdf.aspx").URL + "' style='width:100%; height:540px' style='border: none;'></iframe>";
        ...
        protected void CargaExpedienteID(object sender, CommandEventArgs e)
        {
            ...
            string script = "";
            script = "$('#Expediente').modal('hide'); $('body').removeClass('modal-open'); $('.modal-backdrop').remove(); window.open('" + EncripParametros("IdTramite=" + IdTramite + ",IdExpediente=" + IdExpediente, "../Operador/DisplaypdfExpediente.aspx").URL + "','Expediente', 'width = 600, height = 400');";
            ScriptManager.RegisterStartupScript(this, GetType(), "ServerControlScript", script, true);
        ...
        private Propiedades.UrlCifrardo ConsultaParametros()
        {
            ...
            try
            {
                ...
                foreach (String s in strlist)
                {
                    ...
                    string BusqeudaIdTramite = stringBetween(s + ".", "Procesable=", ".");
