                                            ...
                                            <td>
                                                <td>
                                                    <asp:LinkButton 
                                                        ID="LinkButton3" 
                                                        runat="server" 
                                                        CssClass='<%#Eval("Accion").ToString() == "1" ? "col-md-12 col-sm-12 col-xs-12 btn btn-success" : "col-md-12 col-sm-12 col-xs-12 btn btn-dark" %>' 
                                                        CommandName="Select" 
                                                        CommandArgument='<%#
                                                            Eval("IdTramiteMesa") + "," +
                                                            Eval("Mesa") + "," + 
                                                            Eval("IdTramite")%>' 
                                                        OnClick="AsiganarTramite_Click">Seleccionar Usuario
                                                    </asp:LinkButton>
                                                </td>
                                            </td>
                                        </tr>
