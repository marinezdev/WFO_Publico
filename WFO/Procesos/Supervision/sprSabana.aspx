<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="sprSabana.aspx.cs" Inherits="WFO.Procesos.Supervision.sprSabana" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <script>
        ...
        function resultado(data) {
            ...
            var tabla = "<table id='InfomacionMesas' class='table table-striped table-bordered table-hover jambo_table' style='width:100%'>" +
                "<thead>" +
                "<tr>" +
                        "<td></td>" +
                        "<td>Fecha envió</td>" +
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                        Listado total de trámites, filtro realizado en base a fecha de finalización  sobre una mesa.
                    </p>
                    <div class="row">
                        ...
                        <asp:Repeater ID="rptTramites" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><%#Eval("Kwik")%></td>
                                    <td><button onclick="ShowMesas(<%# Eval("Id")%>); return false;">
                                        <img src="../../Imagenes/folder.png" /></button></td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
                                </tbody>
