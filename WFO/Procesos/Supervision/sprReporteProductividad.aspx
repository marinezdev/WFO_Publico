        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <dx:ASPxDateEdit ID="CalDesde" runat="server" Theme="iOS" EditFormat="Custom" Width="100%" Caption="Desde:">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <dx:ASPxDateEdit ID="CalHasta" runat="server" Theme="iOS" EditFormat="Custom" Width="100%" Caption="Hasta">
                        <TimeSectionProperties Adaptive="true">
                            <TimeEditProperties EditFormatString="hh:mm tt" />
                        </TimeSectionProperties>
                        <CalendarProperties>
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <dx:ASPxDropDownEdit ClientInstanceName="checkComboBox" ID="cmbUsuarios" Width="100%" runat="server" AnimationType="None" Theme="iOS" Caption="Usuario">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12 text-center">
                    <asp:Button ID="btnFiltrar" CssClass="btn btn-success" runat="server" Text="Filtrar" Width="70%" />
                    <br /><br />
                </div>
                <div class="row">
